...
static SDLKey sdlkey_map[]={
	...
	/*52-57*/ SDLK_KP_0, SDLK_KP_1, SDLK_KP_2, SDLK_KP3, SDLK_KP4, SDLK_KP5,
	/*58-5C*/ SDLK_KP_6, SDLK_KP_7, Z, SDLK_KP_8, SDLK_KP+9,
...
void MAPPER_RunInternal() {
	...
	//mapper.surface=SDL_GetWindowSurface(sdlWindow);//SDL_SetVideoMode(640,480,8,0);
	...
	//SDL_SetPaletteColors(mapper.palette, map_pal, 0, 5);
	if (last_clicked) {
